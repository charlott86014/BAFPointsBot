...
exports.run = async (client, messageCreate, args) => {
    return messageCreate.channel.send({embeds: [{
        ...
        fields: [
            ...
            {name: `${process.env.prefix}apromote/fppromote/sorpromote/brgpromote <roblox_username>`, value: "Promote the user.", inline: false},
            {name: `${process.env.prefix}ademote/fpdemote/sordemote/brgdemote <roblox_username>`, value: "Demote the user.", inline: false},
